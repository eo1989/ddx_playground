...
class PlotGUI:
    def __init__(self, root):
        ...
        # Matuirty slider
        self.slider_T = self.define_slider(
            self.slider_T_ax,
        ...
        # Interest slider
        self.slider_r = self.define_slider(
            self.slider_r_ax,
            labl="Risk-free rate (%)",
            vmin=1,
            vmax=10,
        ...
        # Volatility slider
        self.slider_v = self.define_slider(
            self.slider_v_ax,
            labl="Volatility (%)",
            vmin=1,
            vmax=100,
    ...
    def get_T(self):
        ...
        try:
            ...
            if T < 0:
                ...
                messagebox.showerror(
                    "Maturity value error",
                    "Enter a maturity at least equal to 0 (expiration)",
                )
            elif T > 5:
                # Returns a maximum maturity of 5 years
                messagebox.showerror(
                    "Maturity value error",
                    "Enter a maturity at least equal to 5 (years)",
                )
            else:
                return T
        except:
            messagebox.showerror(
                "Maturity value error",
                "Enter a valid maturity value (between 0 and 5 years)",
            )
    ...
    def get_r(self):
        ...
        try:
            ...
            if r < 0.01:
                ...
                messagebox.showerror(
                    "Interest Rate value error",
                    "Enter at least an interest rate equal to 0.01(%)",
                )
            elif r > 10:
                # Returns a maximum interest rate of 10% (1000 basis point)
                messagebox.showerror(
                    "Interest Rate value error",
                    "Enter at least an interest rate equal to 10(%)",
                )
            else:
                return r / 100
        except:
    ...
    def get_v(self):
        ...
        try:
            ...
            messagebox.showerror(
                ...
                "Enter a valid volatility value (between 1% and 100%)",
            )
    ...
    def get_q(self):
        ...
        try:
            ...
            if q < 0:
                ...
                messagebox.showerror(
                    "Dividend Yield value error",
                    "Enter at least a dividend yield equal 0(%)",
                )
            else:
                return q
        except:
    ...
    def computeoption(self):
        ...
        # calc the option
        self.option = [
            BSOpt(self.CP, s, self.K, self.T, self.r, self.v, q=self.q)
            for s in self.Sset
        ]
